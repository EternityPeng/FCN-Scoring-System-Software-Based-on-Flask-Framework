...
def send_registration_link():
    ...
    message = Message("Your Registration Link", sender="1273743240@qq.com", recipients=[email])
    verification_url = url_for('user.register_link', code=code, _external=True)
    message.body = f"Please click the following link to complete your registration: {verification_url} Your register code is: {code}"
